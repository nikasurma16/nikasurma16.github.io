...
def render_font_css():
    ...
    return its path — or None while the folder is empty, so the pages ask for
    nothing until a licensed display face is actually dropped in.
    ...
    scope = ""
    if FONT_SCOPE == "all":
        scope = ('  --sans:"Display",%s;\n  --mono:"Display",%s;\n'
                 % (FALLBACK_SANS, FALLBACK_MONO))
